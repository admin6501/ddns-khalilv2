    ...
    <div className="min-h-screen">
      ...
      <section className="py-20 md:py-28 bg-muted/30" id="pricing">
        <div className="max-w-6xl mx-auto px-4">
          ...
          <div className={`grid grid-cols-1 gap-8 max-w-5xl mx-auto stagger-children ${plans.length <= 3 ? 'md:grid-cols-3' : plans.length <= 4 ? 'md:grid-cols-2 lg:grid-cols-4' : 'md:grid-cols-2 lg:grid-cols-3'}`}>
            {plans.map((plan, i) => (
              <div
                key={i}
