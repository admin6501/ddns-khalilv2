...
async def start_telegram_bot():
    ...
    T = {
        ...
        "en": {
            ...
            "help_login_title": "🔑 **Login Guide**",
            "help_login_body": "Send this command:\n\n`/login email password`\n\nExample:\n`/login user@example.com mypass123`\n\n⚠️ Delete your /login message after successful login.",
            "login_usage": "📧 Please send your email and password:\n\n`/login email password`\n\nExample:\n`/login user@example.com mypass123`",
            "login_fail": "❌ Invalid email or password.",
            "login_success": "✅ Account {name} ({email}) connected!\n\n⚠️ Tip: Delete your /login message.",
